import{i as e,a as t,x as i,V as o,r as a,a2 as r}from"./lucifer.v7.js";import{k as s,p as n,s as c,l,M as w,S as d,R as p,h as u,A as m,j as h,i as v,C as g,m as f,n as b,o as y,E as x,O as k,q as C,u as S,v as R,x as N,T,y as A,z as W,B as $}from"./CfO8u3ub.js";import{c as E,U as I}from"./BuJD_819.js";import"./B-HX8uK0.js";const O=n({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),P=s({state:O,subscribe:e=>l(O,()=>e(O)),subscribeKey:(e,t)=>c(O,e,t),showTooltip({message:e,triggerRect:t,variant:i}){O.open=!0,O.message=e,O.triggerRect=t,O.variant=i},hide(){O.open=!1,O.message="",O.triggerRect={width:0,height:0,top:0,left:0}}}),B={isUnsupportedChainView:()=>"UnsupportedChain"===p.state.view||"SwitchNetwork"===p.state.view&&p.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void w.shake();await d.isSIWXCloseDisabled()?w.shake():w.close()}},j=e`
  :host {
    display: block;
